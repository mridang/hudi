...
class AvroSerializer(
  ...
  private val dateRebaseFunc = SparkDataSourceUtils.creteDateRebaseFuncInWrite(
    datetimeRebaseMode, "Avro")

  private val timestampRebaseFunc = SparkDataSourceUtils.creteTimestampRebaseFuncInWrite(
    datetimeRebaseMode, "Avro")
