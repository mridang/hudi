...
class AvroDeserializer(
  ...
  private val dateRebaseFunc = SparkDataSourceUtils.creteDateRebaseFuncInRead(
    datetimeRebaseMode, "Avro")

  private val timestampRebaseFunc = SparkDataSourceUtils.creteTimestampRebaseFuncInRead(
    datetimeRebaseMode, "Avro")
